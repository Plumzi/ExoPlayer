...
public class PlayerControl implements MediaPlayerControl {
   ...
   * {@link com.google.android.pzexoplayer.MediaCodecAudioTrackRenderer}, the recommended approach is
   * to extend the class and override
   * {@link com.google.android.pzexoplayer.MediaCodecAudioTrackRenderer#onAudioSessionId}.
   *
