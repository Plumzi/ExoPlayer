 ...
 */
package com.google.android.pzexoplayer.demo.player;

import com.google.android.pzexoplayer.C;
import com.google.android.pzexoplayer.DefaultLoadControl;
import com.google.android.pzexoplayer.LoadControl;
import com.google.android.pzexoplayer.MediaCodecAudioTrackRenderer;
import com.google.android.pzexoplayer.MediaCodecUtil.DecoderQueryException;
import com.google.android.pzexoplayer.MediaCodecVideoTrackRenderer;
import com.google.android.pzexoplayer.SampleSource;
import com.google.android.pzexoplayer.TrackRenderer;
import com.google.android.pzexoplayer.audio.AudioCapabilities;
import com.google.android.pzexoplayer.chunk.ChunkSampleSource;
import com.google.android.pzexoplayer.chunk.ChunkSource;
import com.google.android.pzexoplayer.chunk.Format;
import com.google.android.pzexoplayer.chunk.FormatEvaluator;
import com.google.android.pzexoplayer.chunk.FormatEvaluator.AdaptiveEvaluator;
import com.google.android.pzexoplayer.chunk.MultiTrackChunkSource;
import com.google.android.pzexoplayer.chunk.VideoFormatSelectorUtil;
import com.google.android.pzexoplayer.dash.DashChunkSource;
import com.google.android.pzexoplayer.dash.mpd.AdaptationSet;
import com.google.android.pzexoplayer.dash.mpd.MediaPresentationDescription;
import com.google.android.pzexoplayer.dash.mpd.MediaPresentationDescriptionParser;
import com.google.android.pzexoplayer.dash.mpd.Period;
import com.google.android.pzexoplayer.dash.mpd.Representation;
import com.google.android.pzexoplayer.dash.mpd.UtcTimingElement;
import com.google.android.pzexoplayer.dash.mpd.UtcTimingElementResolver;
import com.google.android.pzexoplayer.dash.mpd.UtcTimingElementResolver.UtcTimingCallback;
import com.google.android.pzexoplayer.demo.player.DemoPlayer.RendererBuilder;
import com.google.android.pzexoplayer.drm.MediaDrmCallback;
import com.google.android.pzexoplayer.drm.StreamingDrmSessionManager;
import com.google.android.pzexoplayer.drm.UnsupportedDrmException;
import com.google.android.pzexoplayer.text.TextTrackRenderer;
import com.google.android.pzexoplayer.text.ttml.TtmlParser;
import com.google.android.pzexoplayer.text.webvtt.WebvttParser;
import com.google.android.pzexoplayer.upstream.DataSource;
import com.google.android.pzexoplayer.upstream.DefaultAllocator;
import com.google.android.pzexoplayer.upstream.DefaultBandwidthMeter;
import com.google.android.pzexoplayer.upstream.DefaultUriDataSource;
import com.google.android.pzexoplayer.upstream.UriDataSource;
import com.google.android.pzexoplayer.util.ManifestFetcher;
